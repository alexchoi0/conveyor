...
use etl_dsl::{
    ...
    LegacyPipelineManifest as PipelineManifest, SinkManifest, SourceManifest, TransformManifest,
};
...
fn print_ascii(dag: &etl_dsl::optimizer::OptimizedDag) {
...
fn print_dot(dag: &etl_dsl::optimizer::OptimizedDag) {
